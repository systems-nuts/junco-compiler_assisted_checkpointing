...
if.end28:                                         ; preds = %if.then26, %if.end.lower
  %20 = load float*, float** %new.arr.addr, align 8
  ...
  %22 = load float*, float** %new.arr.addr, align 8
  ...
  %24 = load float, float* %new.l_id, align 4
  ...
  %40 = load float, float* %new.initial.addr, align 4
