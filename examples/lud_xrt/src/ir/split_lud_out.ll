...
for.end68.saveBB.id1:                             ; preds = %for.end68
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %77, i8* align 8 %78, i64 16, i1 true)
  %idx_size.addr = getelementptr inbounds float, float* %ckpt_mem, i32 7
  ...
  %idx_i = getelementptr inbounds float, float* %ckpt_mem, i32 8
  ...
  %idx_j = getelementptr inbounds float, float* %ckpt_mem, i32 9
  ...
  %idx_k = getelementptr inbounds float, float* %ckpt_mem, i32 10
  ...
  %idx_sum = getelementptr inbounds float, float* %ckpt_mem, i32 11
  %deref_sum = load float, float* %new.sum.phi.phi.phi19.phi20, align 4
  store float %deref_sum, float* %idx_sum, align 4
  %idx_p = getelementptr inbounds float, float* %ckpt_mem, i32 12
...
for.end68.restoreBB.id1:                          ; preds = %lud.restoreControllerBB
  ...
  %alloca_contained_result.addr = alloca float, i32 4, align 4
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %80, i8* align 8 %81, i64 16, i1 true)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %82, i8* align 8 %83, i64 16, i1 true)
  %idx_size.addr3 = getelementptr inbounds float, float* %ckpt_mem, i32 7
  ...
  %idx_i4 = getelementptr inbounds float, float* %ckpt_mem, i32 8
  ...
  %idx_j5 = getelementptr inbounds float, float* %ckpt_mem, i32 9
  ...
  %idx_k6 = getelementptr inbounds float, float* %ckpt_mem, i32 10
  ...
  %idx_sum7 = getelementptr inbounds float, float* %ckpt_mem, i32 11
  ...
  %idx_p8 = getelementptr inbounds float, float* %ckpt_mem, i32 12
