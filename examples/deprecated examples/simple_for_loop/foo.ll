...
for.body:                                         ; preds = %for.cond
  ...
  %call = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %k, i32* noundef nonnull align 4 dereferenceable(4) %arrayidx2)
  %5 = load i32, i32* %call, align 4
  store i32 %5, i32* %k, align 4
  call void @_Z10checkpointv()
  br label %for.inc
