; ModuleID = '../../examples/ex2/testing/split_kernel.ll'
...
workload.restoreControllerBB:                     ; preds = %entry
  %idx_ckpt_id_load = getelementptr inbounds i32, i32* %ckpt_mem, i32 0
  %load.ckpt_id = load i32, i32* %idx_ckpt_id_load, align 4
  switch i32 %load.ckpt_id, label %callBB.upper [
    i32 1, label %callBB.upper.restoreBB.id1
  ]

callBB.upper:                                     ; preds = %workload.restoreControllerBB
  %0 = load i32, i32* %l_id, align 4
  br label %callBB.upper.saveBB.id1

callBB.upper.saveBB.id1:                          ; preds = %callBB.upper
  ...
  %idx_l_id = getelementptr inbounds i32, i32* %ckpt_mem, i32 3
  store i32 %deref_l_id, i32* %idx_l_id, align 4
  %idx_0 = getelementptr inbounds i32, i32* %ckpt_mem, i32 4
  store i32 %0, i32* %idx_0, align 4
  ...
  br label %callBB.upper.junctionBB.id1

callBB.upper.junctionBB.id1:                      ; preds = %callBB.upper.restoreBB.id1, %callBB.upper.saveBB.id1
  %new.retval = phi i32* [ %retval, %callBB.upper.saveBB.id1 ], [ %alloca.retval, %callBB.upper.restoreBB.id1 ]
  %new.l_id = phi i32* [ %l_id, %callBB.upper.saveBB.id1 ], [ %alloca.l_id, %callBB.upper.restoreBB.id1 ]
  %new.0 = phi i32 [ %0, %callBB.upper.saveBB.id1 ], [ %load.0, %callBB.upper.restoreBB.id1 ]
  br label %callBB.lower

callBB.lower:                                     ; preds = %callBB.upper.junctionBB.id1
  %cmp = icmp ne i32 %new.0, 0
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %callBB.lower
  %1 = load i32, i32* %new.l_id, align 4
...
if.else:                                          ; preds = %callBB.lower
  %2 = load i32, i32* %new.l_id, align 4
...
return:                                           ; preds = %if.else, %if.then
  %new.retval.phi = phi i32* [ %new.retval, %if.else ], [ %new.retval, %if.then ]
  %3 = load i32, i32* %new.retval.phi, align 4
  ret i32 %3

callBB.upper.restoreBB.id1:                       ; preds = %workload.restoreControllerBB
  ...
  %idx_l_id2 = getelementptr inbounds i32, i32* %ckpt_mem, i32 3
  %load.l_id = load i32, i32* %idx_l_id2, align 4
  %alloca.l_id = alloca i32, align 4
  store i32 %load.l_id, i32* %alloca.l_id, align 4
  %idx_03 = getelementptr inbounds i32, i32* %ckpt_mem, i32 4
  %load.0 = load i32, i32* %idx_03, align 4
