...
extern "C"{
  ...
  /*#FUNCTION_DEF#*/
  int workload(float ckpt_mem[8], int initial, float arr[2])
  {
    int l_id = 0;
    ...
    printf("initial=%d, arr[0]=%f, arr[1]=%f\n", initial, arr[0], arr[1]);
    ...
    printf("process l_id = %d, ckpt_mem ptr %p, heartbeat %f, CKPT_ID %f, VAR_0 %f, VAR_1 %f, VAR_2 %f, VAR_3 %f, VAR_4 %f\n", 
