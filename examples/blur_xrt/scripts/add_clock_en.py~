...
def write_router(outfile, index, router_type):
    outfile.write("\trouter_"+str(index)+": " + router_types[router_type] + " {\n")
    outfile.write("\t\tparameters:\n")
    outfile.write("\t\t\tnumPorts = "+ str(MAX_DEG_ROUTER)+ ";\n")
    outfile.write("\t\t\tid = "+str(index)+";\n")
    outfile.write("\t\t\t@display(\"p="+str((int(index%num_cols)+1)*150)+","+str((int(index/num_cols)+1)*150)+"\");\n")
    outfile.write("\t\tgates:\n")
    outfile.write("\t\t\tin["+ str(MAX_DEG_ROUTER)+ "];\n")
    outfile.write("\t\t\tout["+ str(MAX_DEG_ROUTER)+ "];\n")
    outfile.write("\t}\n")
    outfile.write("\n\n")
