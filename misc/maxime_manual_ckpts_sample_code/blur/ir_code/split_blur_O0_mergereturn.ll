; ModuleID = '../../misc/maxime_manual_ckpts_sample_code/blur/ir_code/blur_O0_mergereturn.ll'
...
for.cond11.upper:                                 ; preds = %for.inc98, %if.end
...
for.body13:                                       ; preds = %for.cond11.lower
  ...
  br label %for.cond14.upper

for.cond14.upper:                                 ; preds = %for.inc85, %for.body13
  %17 = load i32, i32* %i, align 4
  br label %for.cond14.lower

for.cond14.lower:                                 ; preds = %for.cond14.upper
  %cmp15 = icmp slt i32 %17, 1641
  br i1 %cmp15, label %for.body16, label %for.end87

for.body16:                                       ; preds = %for.cond14.lower
  store i32 0, i32* %j, align 4
  br label %for.cond17.upper

for.cond17.upper:                                 ; preds = %for.inc82, %for.body16
  %18 = load i32, i32* %j, align 4
  br label %for.cond17.lower

for.cond17.lower:                                 ; preds = %for.cond17.upper
  %cmp18 = icmp slt i32 %18, 2191
  br i1 %cmp18, label %for.body19, label %for.end84

for.body19:                                       ; preds = %for.cond17.lower
  store i32 0, i32* %h, align 4
  br label %for.cond20.upper

for.cond20.upper:                                 ; preds = %for.inc64, %for.body19
  %19 = load i32, i32* %h, align 4
  br label %for.cond20.lower

for.cond20.lower:                                 ; preds = %for.cond20.upper
  %cmp21 = icmp slt i32 %19, 10
  br i1 %cmp21, label %for.body22, label %for.end66

for.body22:                                       ; preds = %for.cond20.lower
  store i32 0, i32* %w, align 4
  br label %for.cond23.upper

for.cond23.upper:                                 ; preds = %for.inc61, %for.body22
  %20 = load i32, i32* %w, align 4
  br label %for.cond23.lower

for.cond23.lower:                                 ; preds = %for.cond23.upper
  %cmp24 = icmp slt i32 %20, 10
  br i1 %cmp24, label %for.body25, label %for.end63

for.body25:                                       ; preds = %for.cond23.lower
...
for.inc61:                                        ; preds = %for.body25
  ...
  br label %for.cond23.upper, !llvm.loop !8

for.end63:                                        ; preds = %for.cond23.lower
  br label %for.inc64
...
for.inc64:                                        ; preds = %for.end63
  ...
  br label %for.cond20.upper, !llvm.loop !9

for.end66:                                        ; preds = %for.cond20.lower
...
for.inc82:                                        ; preds = %for.end66
  ...
  br label %for.cond17.upper, !llvm.loop !10

for.end84:                                        ; preds = %for.cond17.lower
  br label %for.inc85
...
for.inc85:                                        ; preds = %for.end84
  ...
  br label %for.cond14.upper, !llvm.loop !11

for.end87:                                        ; preds = %for.cond14.lower
  store i32 0, i32* %ind, align 4
  br label %for.cond88.upper

for.cond88.upper:                                 ; preds = %for.inc95, %for.end87
  %70 = load i32, i32* %ind, align 4
  br label %for.cond88.lower

for.cond88.lower:                                 ; preds = %for.cond88.upper
  %cmp89 = icmp slt i32 %70, 10890000
  br i1 %cmp89, label %for.body90, label %for.end97

for.body90:                                       ; preds = %for.cond88.lower
...
for.inc95:                                        ; preds = %for.body90
  ...
  br label %for.cond88.upper, !llvm.loop !12

for.end97:                                        ; preds = %for.cond88.lower
  br label %for.inc98
...
for.inc98:                                        ; preds = %for.end97
  ...
  br label %for.cond11.upper, !llvm.loop !13

for.end100:                                       ; preds = %for.cond11.lower
