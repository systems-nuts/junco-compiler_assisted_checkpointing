...
checkpoint.restoreControllerBB:                   ; preds = %entry.upper
  ...
  switch i8 %loaded.CheckpointID, label %entry.lower [
    i8 0, label %for.body.preheader.restoreBB.id0
  ]
...
for.body.preheader:                               ; preds = %entry.lower
  ...
  br label %for.body.preheader.saveBB.id0

for.body.preheader.saveBB.id0:                    ; preds = %for.body.preheader
  ...
  store i64 %wide.trip.count, i64* %store.wide.trip.count_address, align 8
  br label %for.body.preheader.junctionBB.id0

for.body.preheader.junctionBB.id0:                ; preds = %for.body.preheader.restoreBB.id0, %for.body.preheader.saveBB.id0
  %new.ckpt_mem = phi float* [ %ckpt_mem, %for.body.preheader.saveBB.id0 ], [ %loaded.ckpt_mem, %for.body.preheader.restoreBB.id0 ]
  %new.result = phi float* [ %result, %for.body.preheader.saveBB.id0 ], [ %loaded.result, %for.body.preheader.restoreBB.id0 ]
  %new.wide.trip.count = phi i64 [ %wide.trip.count, %for.body.preheader.saveBB.id0 ], [ %loaded.wide.trip.count, %for.body.preheader.restoreBB.id0 ]
  br label %for.body.upper

for.cond.cleanup:                                 ; preds = %for.body.lower, %entry.lower
  %new.result.phi.phi = phi float* [ %new.result.phi, %for.body.lower ], [ %result, %entry.lower ]
  %new.ckpt_mem.phi.phi = phi float* [ %new.ckpt_mem.phi, %for.body.lower ], [ %ckpt_mem, %entry.lower ]
  ret void

for.body.upper:                                   ; preds = %for.body.lower, %for.body.preheader.junctionBB.id0
  %new.wide.trip.count.phi = phi i64 [ %new.wide.trip.count.phi, %for.body.lower ], [ %new.wide.trip.count, %for.body.preheader.junctionBB.id0 ]
  %new.result.phi = phi float* [ %new.result.phi, %for.body.lower ], [ %new.result, %for.body.preheader.junctionBB.id0 ]
  %new.ckpt_mem.phi = phi float* [ %new.ckpt_mem.phi, %for.body.lower ], [ %new.ckpt_mem, %for.body.preheader.junctionBB.id0 ]
  %indvars.iv = phi i64 [ 0, %for.body.preheader.junctionBB.id0 ], [ %indvars.iv.next, %for.body.lower ]
  %arrayidx5 = getelementptr inbounds float, float* %new.result.phi, i64 %indvars.iv
  %1 = load float, float* %arrayidx5, align 4, !tbaa !9
  %2 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx7 = getelementptr inbounds float, float* %new.ckpt_mem.phi, i64 %2
  store float %1, float* %arrayidx7, align 4, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.body.lower

for.body.lower:                                   ; preds = %for.body.upper
  %exitcond.not = icmp eq i64 %indvars.iv.next, %new.wide.trip.count.phi
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body.upper, !llvm.loop !11

for.body.preheader.restoreBB.id0:                 ; preds = %checkpoint.restoreControllerBB
...
for.cond8.loopexit.upper:                         ; preds = %for.end63.lower, %for.end39.lower
  %new.ckpt_mem.phi9.phi.phi10.phi = phi float* [ %new.ckpt_mem.phi9.phi.phi10.phi11.phi12, %for.end63.lower ], [ %new.ckpt_mem.phi9.phi.phi10, %for.end39.lower ]
  %new.size.phi5.phi.phi6.phi = phi i32 [ %new.size.phi5.phi.phi6.phi7.phi8, %for.end63.lower ], [ %new.size.phi5.phi.phi6, %for.end39.lower ]
  %new.result.phi1.phi.phi2.phi = phi float* [ %new.result.phi1.phi.phi2.phi3.phi4, %for.end63.lower ], [ %new.result.phi1.phi.phi2, %for.end39.lower ]
...
for.cond11.preheader:                             ; preds = %for.cond8.loopexit.lower, %for.cond11.preheader.preheader
  %new.ckpt_mem.phi9 = phi float* [ %new.ckpt_mem.phi9.phi.phi10.phi, %for.cond8.loopexit.lower ], [ %new.ckpt_mem, %for.cond11.preheader.preheader ]
  %new.size.phi5 = phi i32 [ %new.size.phi5.phi.phi6.phi, %for.cond8.loopexit.lower ], [ %new.size, %for.cond11.preheader.preheader ]
  %new.result.phi1 = phi float* [ %new.result.phi1.phi.phi2.phi, %for.cond8.loopexit.lower ], [ %new.result, %for.cond11.preheader.preheader ]
...
for.body13.upper:                                 ; preds = %for.end32.lower, %for.cond11.preheader
  %new.ckpt_mem.phi9.phi = phi float* [ %new.ckpt_mem.phi9.phi.phi10, %for.end32.lower ], [ %new.ckpt_mem.phi9, %for.cond11.preheader ]
  %new.size.phi5.phi = phi i32 [ %new.size.phi5.phi.phi6, %for.end32.lower ], [ %new.size.phi5, %for.cond11.preheader ]
  %new.result.phi1.phi = phi float* [ %new.result.phi1.phi.phi2, %for.end32.lower ], [ %new.result.phi1, %for.cond11.preheader ]
  ...
  %arrayidx17 = getelementptr inbounds float, float* %new.result.phi1.phi, i64 %13
...
for.body20.upper:                                 ; preds = %for.body20.lower, %for.body13.lower
  %new.ckpt_mem.phi9.phi.phi = phi float* [ %new.ckpt_mem.phi9.phi.phi, %for.body20.lower ], [ %new.ckpt_mem.phi9.phi, %for.body13.lower ]
  %new.size.phi5.phi.phi = phi i32 [ %new.size.phi5.phi.phi, %for.body20.lower ], [ %new.size.phi5.phi, %for.body13.lower ]
  %new.result.phi1.phi.phi = phi float* [ %new.result.phi1.phi.phi, %for.body20.lower ], [ %new.result.phi1.phi, %for.body13.lower ]
  ...
  %arrayidx24 = getelementptr inbounds float, float* %new.result.phi1.phi.phi, i64 %15
  %16 = load float, float* %arrayidx24, align 4, !tbaa !9
  %17 = mul nsw i64 %indvars.iv167, %4
  %18 = add nsw i64 %17, %indvars.iv177
  %arrayidx28 = getelementptr inbounds float, float* %new.result.phi1.phi.phi, i64 %18
...
for.end32.upper:                                  ; preds = %for.body20.lower, %for.body13.lower
  %new.ckpt_mem.phi9.phi.phi10 = phi float* [ %new.ckpt_mem.phi9.phi.phi, %for.body20.lower ], [ %new.ckpt_mem.phi9.phi, %for.body13.lower ]
  %new.size.phi5.phi.phi6 = phi i32 [ %new.size.phi5.phi.phi, %for.body20.lower ], [ %new.size.phi5.phi, %for.body13.lower ]
  %new.result.phi1.phi.phi2 = phi float* [ %new.result.phi1.phi.phi, %for.body20.lower ], [ %new.result.phi1.phi, %for.body13.lower ]
...
for.body43.lr.ph:                                 ; preds = %for.end39.lower
  ...
  %mul64 = mul nsw i32 %indvars199, %new.size.phi5.phi.phi6
  %21 = sext i32 %mul64 to i64
  %22 = add nsw i64 %indvars.iv175, %21
  %arrayidx67 = getelementptr inbounds float, float* %new.result.phi1.phi.phi2, i64 %22
...
for.body43.upper:                                 ; preds = %for.end63.lower, %for.body43.lr.ph
  %new.ckpt_mem.phi9.phi.phi10.phi11 = phi float* [ %new.ckpt_mem.phi9.phi.phi10.phi11.phi12, %for.end63.lower ], [ %new.ckpt_mem.phi9.phi.phi10, %for.body43.lr.ph ]
  %new.size.phi5.phi.phi6.phi7 = phi i32 [ %new.size.phi5.phi.phi6.phi7.phi8, %for.end63.lower ], [ %new.size.phi5.phi.phi6, %for.body43.lr.ph ]
  %new.result.phi1.phi.phi2.phi3 = phi float* [ %new.result.phi1.phi.phi2.phi3.phi4, %for.end63.lower ], [ %new.result.phi1.phi.phi2, %for.body43.lr.ph ]
  ...
  %arrayidx47 = getelementptr inbounds float, float* %new.result.phi1.phi.phi2.phi3, i64 %24
...
for.body50.upper:                                 ; preds = %for.body50.lower, %for.body43.lower
  %new.ckpt_mem.phi9.phi.phi10.phi11.phi = phi float* [ %new.ckpt_mem.phi9.phi.phi10.phi11.phi, %for.body50.lower ], [ %new.ckpt_mem.phi9.phi.phi10.phi11, %for.body43.lower ]
  %new.size.phi5.phi.phi6.phi7.phi = phi i32 [ %new.size.phi5.phi.phi6.phi7.phi, %for.body50.lower ], [ %new.size.phi5.phi.phi6.phi7, %for.body43.lower ]
  %new.result.phi1.phi.phi2.phi3.phi = phi float* [ %new.result.phi1.phi.phi2.phi3.phi, %for.body50.lower ], [ %new.result.phi1.phi.phi2.phi3, %for.body43.lower ]
  ...
  %arrayidx54 = getelementptr inbounds float, float* %new.result.phi1.phi.phi2.phi3.phi, i64 %26
  %27 = load float, float* %arrayidx54, align 4, !tbaa !9
  %28 = mul nsw i64 %indvars.iv181, %7
  %29 = add nsw i64 %28, %indvars.iv175
  %arrayidx58 = getelementptr inbounds float, float* %new.result.phi1.phi.phi2.phi3.phi, i64 %29
...
for.end63.upper:                                  ; preds = %for.body50.lower, %for.body43.lower
  %new.ckpt_mem.phi9.phi.phi10.phi11.phi12 = phi float* [ %new.ckpt_mem.phi9.phi.phi10.phi11.phi, %for.body50.lower ], [ %new.ckpt_mem.phi9.phi.phi10.phi11, %for.body43.lower ]
  %new.size.phi5.phi.phi6.phi7.phi8 = phi i32 [ %new.size.phi5.phi.phi6.phi7.phi, %for.body50.lower ], [ %new.size.phi5.phi.phi6.phi7, %for.body43.lower ]
  %new.result.phi1.phi.phi2.phi3.phi4 = phi float* [ %new.result.phi1.phi.phi2.phi3.phi, %for.body50.lower ], [ %new.result.phi1.phi.phi2.phi3, %for.body43.lower ]
...
for.end77:                                        ; preds = %for.cond8.loopexit.lower, %if.end.lower
  %new.ckpt_mem.phi = phi float* [ %new.ckpt_mem.phi9.phi.phi10.phi, %for.cond8.loopexit.lower ], [ %new.ckpt_mem, %if.end.lower ]
  %new.size.phi = phi i32 [ %new.size.phi5.phi.phi6.phi, %for.cond8.loopexit.lower ], [ %new.size, %if.end.lower ]
  %new.result.phi = phi float* [ %new.result.phi1.phi.phi2.phi, %for.cond8.loopexit.lower ], [ %new.result, %if.end.lower ]
