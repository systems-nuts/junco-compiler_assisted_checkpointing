; ModuleID = '../../inputs/ll_files/kernel.ll'
...
@str = private unnamed_addr constant [28 x i8] c"Start of function: workload\00", align 1
...
define dso_local i32 @workload(i32* nocapture noundef readnone %ckpt_mem) local_unnamed_addr #3 {
entry:
  %puts = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @str, i64 0, i64 0))
  %call2 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([43 x i8], [43 x i8]* @.str.2, i64 0, i64 0), i32 noundef 0)
  ret i32 0
}
...
define internal void @_GLOBAL__sub_I_kernel.cpp() #5 section ".text.startup" {
entry:
