; ModuleID = '../../misc/maxime_manual_ckpts_sample_code/blur/ir_code/blur.ll'
...
for.body.upper:                                   ; preds = %for.body.lower, %if.then
  %indvars.iv = phi i64 [ 0, %if.then ], [ %indvars.iv.next, %for.body.lower ]
